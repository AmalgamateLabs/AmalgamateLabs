...
namespace AmalgamateLabs.Base
{
    ...
    {
        // Encryption: stackoverflow.com/questions/202011/encrypt-and-decrypt-a-string/10366194#10366194
        // Hashing: devproconnections.com/aspnet/aspnet-web-security-protect-user-passwords-hashing-and-salt
        ...
        public static string HashPassword(string password, string salt, int iterations = 300)
        {
            string hash = string.Empty;

            for (int i = 0; i < iterations; i++)
            {
                string combinedPassword = string.Concat(hash, string.Concat(password, salt));
        ...
        public bool ValidateHasedPassword(string enteredPassword, string storedHash, string storedSalt)
        {
