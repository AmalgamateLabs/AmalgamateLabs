function UnityProgress (dom) {
    ...
    var templateDataPath = "../../WebGL_Games/TemplateData/";

	var logoImage = document.createElement("img");
	var splashStyle = Module["splashStyle"] ? Module["splashStyle"] : "Light";
    logoImage.src = templateDataPath + "Logo." + splashStyle + ".png"; 
	logoImage.style.position = "absolute";
	parent.appendChild(logoImage);
	this.logoImage = logoImage;

	var progressFrame = document.createElement("img");
    progressFrame.src = templateDataPath + "ProgressFrame." + splashStyle + ".png"; 
    ...
    progressBarImg.src = templateDataPath + "ProgressBar." + splashStyle + ".png"; 
